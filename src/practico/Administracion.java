...
public class Administracion {
    //<> el tipo de datos que se va almacenar en el arrNota
    //para poder acceder desde otras clases
   public ArrayList<Notas> arrNotas;//creamos el array tipo
   public ArrayList<Notas> arrBestNotas;//creamos el array tipo
